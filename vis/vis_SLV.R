...
data <- read.csv(file.path(folder, '..', 'results', 'model_results', 'SLV', filename))
...
dir.create(file.path(folder, '..', 'reports', 'images', 'SLV'), showWarnings = FALSE)
path = file.path(folder, '..', 'reports', 'images', 'SLV', 'social_costs_by_strategy.png')
ggsave(path, units="in", width=8, height=7, dpi=300)
dev.off()
...
ggsave(path, units="in", width=8, height=7, dpi=300)
path = file.path(folder, '..', 'reports', 'images', 'SLV', 'social_costs_by_sharing_strategy.png')
ggsave(path, units="in", width=8, height=7, dpi=300)
dev.off()
...
ggsave(path, units="in", width=8, height=7, dpi=300)
path = file.path(folder, '..', 'reports', 'images', 'SLV', 'social_costs_by_policy_options.png')
ggsave(path, units="in", width=8, height=7, dpi=300)
dev.off()
